...
2. link:https://firebase.google.com/docs/flutter/setup?platform=ios[flutter에 firebase 추가]가 되었다. android, ios, web, desktop 모두 따로 firebase를 설정해야했는데 이젠 한번에 flutter를 지원한다.
