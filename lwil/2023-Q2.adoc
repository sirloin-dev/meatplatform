...
현대 M몰이라는 앱에서 구매를 하면 2개월동안은 1개월치 금액으로 구독이 가능하다고 했다. 바로 구매를 했고, 쿠폰을 발급받았다. 하지만 디즈니 플러스에서 쿠폰을 등록하려고 대략 2시간동안 찾았으나.. 
못찾았고 네이버에서 방법을 알아보았으나 헛소리하는 지식인밖에 없었다.. 포기하려는 찰나에 구매했던 현대 M몰에서 '쿠폰등록하기' 라는 버튼을 찾았고, 그제서야 디즈니플러스 앱으로 라우팅되면서 등록하는 페이지가 떴다. 
