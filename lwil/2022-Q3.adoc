...
+
link:https://docs.jboss.org/hibernate/jpa/2.1/api/javax/persistence/AttributeOverride.html[@AttributeOverride] 나 link:https://docs.jboss.org/hibernate/jpa/2.1/api/javax/persistence/AssociationOverrides.html[@AssociationOverrides] 를 이용해 해결할 수 있다.
